...
<!-- Mirrored from bslthemes.com/myour/demo/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Dec 2020 23:53:31 GMT -->
<head>
	...
	<!-- Title -->
	<title>Victor's Portfolios</title>
...
<body class="home">
 ...
 // Send the email:
 mail('victorigbokwe60@gmail.com', 'Contact Form Submission', $body, "From: {$_POST['email']}"); echo '<p><em>Thank you for contacting me. 
 ...
 ?>
		...
		<header class="header">
			...
			<div class="logo">
				<a href="#">
					...
					<span class="logo-lnk">Victor <br />Igbokwe</span>
				</a>
			</div>
			...
			<!-- download cv button -->
			<a href="files/cv.html" class="btn download-cv-btn">
		...
		<div class="wrapper">
			...
			<div class="background-bg">
				<div class="background-filter gradient">
					<div class="background-img" style="background-image: url(images/profiles.jpg);"></div>
				</div>
			</div>
				...
				<div class="centrize full-width">
					<div class="vertical-center">
						...
						<div class="started-content">
							...
							<!-- text -->
							<div class="h-text">
								Hello! I am Web Developer from Nigeria. I have rich experience in web site design and building, also I am good at wordpress. I love to talk with you about our unique services.
							</div>
				...
				<div class="content">
					...
					<div class="cols">
						<div class="col">
							<div class="single-post-text">
								<p>
									I am a skilled artist presenting unique projects. I work both with businesses and individuals, and always find a non-standard approach to the task.
								</p>
							</div>
						</div>
						<div class="col">
							<div class="single-post-text">
								<p>
									I'm open to the possibility of cooperation with brands and artists. Let's create something great together!
								</p>
							</div>
						</div>
						<div class="col col-full">
							<div class="single-post-text">
								<p>
									I am a hard-working and motivated individual with a proven record in project management. I always strive to achieve the highest standard possible, at any given task in any situation. 
								</p>
							</div>
						</div>
					</div>
					...
					<div class="info-list">
						<ul>
							...
							<li><strong>Address:</strong> Umuahia,Abia state</li>
							<li><strong>Phone:</strong> +234 81 341 06 143</li>
							<li><strong>E-mail:</strong> victor60@gmail.com</li>
						</ul>
					</div>
						...
						<div class="owl-carousel" data-slidesview="2" data-slidesview_mobile="1">
							...
							<div class="item">
								<div class="resume-item active">
									...
									<div class="name">Zeon Global <br />Good Food, NG</div>
									<div class="single-post-text">
										<p>“Victor is a talented artist and a very pleasant person, inspiring everyone around with his vision and creativity."
										</p>
									</div>
								</div>
							</div>
							...
							<div class="item">
								<div class="resume-item">
									...
									<div class="name">GPH <br />Trading Comapany</div>
									<div class="single-post-text">
										<p>"We are absolutely satisfied with our co-operation with Victor."</p>
									</div>
								</div>
							</div>
							...
							<div class="item">
								<div class="resume-item">
									...
									<div class="single-post-text">
										<p>"Victor is a skilled individual who gives his very best".</p>
									</div>
								</div>
							</div>
						...
						<div class="owl-carousel" data-slidesview="2" data-slidesview_mobile="1">
							...
							<div class="item">
								<div class="resume-item active">
									...
									<div class="name">Abia State University, <br />	Uturu</div>
									<div class="single-post-text">
										<p>I am a student of the prestigious Abia State University.Currently I'm in 300 level.</p>
									</div>
								</div>
							</div>
							...
							<div class="item">
								<div class="resume-item">
									...
									<div class="name">Programming Course <br />Udeemy</div>
									<div class="single-post-text">
										<p>
										I'm a certified member of the course "Python from zero to Hero!". 
										</p>
									</div>
								</div>
							</div>
							...
							<div class="item">
								<div class="resume-item">
									...
									<div class="name">Web Design Course <br />Udeemy</div>
									<div class="single-post-text">
										<p>
											I'm a certified member of the course "The complete bootcamp tutorial".
										</p>
									</div>
								</div>
							</div>
					...
					<div class="skills circles">
						<ul>
							<li>
								...
								<div class="single-post-text">
									<p>
										Skilled in PHP and database handling.
									</p>
								</div>
							</li>
							<li>
							...
							<li>
								<div class="progress p62"> <!-- p90 = 90% circle fill color -->
									<div class="percentage"></div>
									<span>62%</span>
								</div>
						...
						<div class="owl-carousel" data-slidesView="2" data-slidesview_mobile="1">
							...
							<div class="item">
								<div class="reviews-item">
									...
									<div class="info">
										<div class="name">Zeon Global</div>
										<div class="company">Manager</div>
									</div>
									<div class="text">
										Working with Victor has been a pleasure. Better yet - I alerted him of a minor issue before going to sleep. The issue was fixed the next morning. I couldn't ask for better support. Thank you Victor!
							...
							<div class="item">
								<div class="reviews-item">
									...
									<div class="info">
										<div class="name">Godson Igbokwe</div>
										<div class="company">Engineer</div>
									</div>
									<div class="text">
										Excellent all around! What stood out most was Victor's excellent service. He made sure our services were rendered on time even during the Holiday periods.I hope, we'll work together on many more great projects.
									</div>
								</div>
							</div>
						</div>
  ...
  <div class="titles">
					<div class="subtitle task">Coming Soon!</div>
					<div class="clear"></div>
				</div>
				</div>
			</div>
			...
			<div class="section contacts" id="section-contacts">
				<div class="content">
						...
						<form action="index.php" method="POST">
							<div class="group-val">
								<div class="label">Full name <strong>*</strong></div>
   								<input type="text" name="name" value="<?php if(isset($_POST['name'])) echo $_POST['name']; ?>" placeholder="e.g: Victor Igbokwe" />
							</div>
							<div class="group-val">
								<div class="label">Email address <strong>*</strong></div>
								<input type="email" name="email" value="<?php if(isset($_POST['email'])) echo $_POST['email']; ?>" placeholder="example@gmail.com" />
							</div>
							<div class="group-val">
								<div class="label">Message <strong>*</strong></div>
								<textarea name="comments" placeholder="Type your message" value="<?php if(isset($_POST['comments'])) echo $_POST['comments']; ?>"></textarea>
							</div>
							<div class="group-bts">
								<button type="submit" class="btn" value="send" name="submit">
					...
					<div class="contact-info">
						<div class="name">Victor Igbokwe</div>
						...
						<div class="info-list">
							<ul>
								...
								<li><strong>Address:</strong> Umuahia,Abia State</li>
								<li><strong>Phone:</strong> +234 81 341 06 143</li>
								<li><strong>E-mail:</strong><tt><span>victor60@gmail.com</span></tt></li>
							</ul>
						</div>
						<div class="author">Victor Igbokwe</div>
					</div>
...
<!-- Mirrored from bslthemes.com/myour/demo/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Dec 2020 23:53:32 GMT -->
</html>